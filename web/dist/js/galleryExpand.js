  ...
  var methods = {
    ...
    init : function(options) {
      ...
      return this.each(function(i) {
        ...
        var fillScreen = !!$object.length && ($(this).attr('data-fillScreen') || options.fillScreen);
        ...
        var cardPadding;
        var contentPadding = options.contentPadding;
        ...
        origin.off('click.galleryExpand').on('click.galleryExpand', function(e) {
          ...
          var recalculateVars = function() {
            ...
            // States
            fullWidth = windowWidth <= options.responsiveThreshold;
            ...
            contentPadding = fullWidth ? 20 : options.contentPadding;
          ...
          // Color sample
          primaryColor = options.defaultColor;
          if (typeof ColorThief !== "undefined" && $object.length) {
            ...
            try {
              ...
              primaryColor = 'rgb(' + sampledColorPalette[0][0] + ',' +  sampledColorPalette[0][1] + ',' + sampledColorPalette[0][2] + ')';
              secondaryColor = 'rgb(' + sampledColorPalette[1][0] + ',' +  sampledColorPalette[1][1] + ',' + sampledColorPalette[1][2] + ')';
          ...
          objectCssObject.transition = 'transform ' + (options.inDuration / 1000) + 's';
          objectCssObject['-webkit-transition'] = '-webkit-transform ' + (options.inDuration / 1000) + 's';
          ...
          if (objectSizeAdjusted) {
            ...
            if (fillScreen) {
              ...
              objectCssObject.transition = 'transform ' + (options.inDuration / 1000) + 's, width ' + (options.inDuration / 1000) + 's, height ' + (options.inDuration / 1000) + 's';
              objectCssObject['-webkit-transition'] = '-webkit-transform ' + (options.inDuration / 1000) + 's, width ' + (options.inDuration / 1000) + 's, height ' + (options.inDuration / 1000) + 's';
          ...
          $curveWrapper.css({
            height: windowHeight,
            transition: 'transform ' + (options.inDuration / 1000) + 's ' + bezierCurve,
            '-webkit-transition': '-webkit-transform ' + (options.inDuration / 1000) + 's ' + bezierCurve,
            transform: ''
          });
        ...
        function returnToOriginal() {
          ...
          setTimeout(function() {
            ...
            $('#placeholder-navbar').fadeOut(options.outDuration, 'easeInQuad', function(){
              $(this).remove();
            });
            ...
            overlay.fadeOut(options.outDuration, 'easeInQuad', function() {
              $(this).remove();
            });
            ...
            if (!cancelledTimeout) {
              ...
              origin.css({
                ...
                transition: 'transform ' + (options.outDuration / 1000) + 's ' + bezierCurve,
                '-webkit-transition': '-webkit-transform ' + (options.outDuration / 1000) + 's ' + bezierCurve
              });
              ...
              if (objectSizeAdjusted && fillScreen) {
                ...
                objectCssObject.transition = 'transform ' + (options.outDuration / 1000) + 's, width ' + (options.outDuration / 1000) + 's, height ' + (options.outDuration / 1000) + 's';
                objectCssObject['-webkit-transition'] = '-webkit-transform ' + (options.outDuration / 1000) + 's, width ' + (options.outDuration / 1000) + 's, height ' + (options.outDuration / 1000) + 's';
                ...
                objectCssObject.transition = 'transform ' + (options.outDuration / 1000) + 's ' + bezierCurve;
                objectCssObject['-webkit-transition'] = '-webkit-transform ' + (options.outDuration / 1000) + 's ' + bezierCurve;
              }
              $object.css(objectCssObject);
